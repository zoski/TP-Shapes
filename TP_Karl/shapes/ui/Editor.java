...
public class Editor extends JFrame
{
	...
	private void buildModel()
	{
		...
		c.addAttributes(new ColorAttributes(false,true,Color.RED,Color.BLUE));
		c.addAttributes(new SelectionAttributes());
		this.model.add(c);
		
		SText t= new SText(new Point(100,100),"hello");
		t.addAttributes(new ColorAttributes(false,true,Color.YELLOW,Color.BLUE));
		...
		c.addAttributes(new ColorAttributes(true,true,Color.LIGHT_GRAY,Color.DARK_GRAY));
		c.addAttributes(new SelectionAttributes());
		sc.add(c);
